import { getMode, h, Host, createEvent, proxyCustomElement } from '@stencil/core/internal/client';
export { setAssetPath, setPlatformOptions } from '@stencil/core/internal/client';

const slideCss = "ionx-slide{display:block;width:100%;height:100%}.slide-zoom{display:block;width:100%;text-align:center}.swiper-slide{display:flex;position:relative;flex-shrink:0;align-items:center;justify-content:center;width:100%;height:100%;font-size:18px;text-align:center;box-sizing:border-box}.swiper-slide img{width:auto;max-width:100%;height:auto;max-height:100%}";
...
const waitForSlides = (el) => {
  return Promise.all(Array.from(el.querySelectorAll('ionx-slide')).map(s => typeof s.componentOnReady === "function" ? s.componentOnReady() : Promise.resolve(s)));
};

const IonxSlide = /*@__PURE__*/proxyCustomElement(Slide, [0,"ionx-slide"]);
const IonxSlides = /*@__PURE__*/proxyCustomElement(Slides, [4,"ionx-slides",{"options":[8],"pager":[4],"scrollbar":[4]}]);
const defineIonxSlides = (opts) => {
...
export { IonxSlide, IonxSlides, defineIonxSlides };
