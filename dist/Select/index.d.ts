...
interface IonxSelect extends Components.IonxSelect, HTMLElement {}
export const IonxSelect: {
  prototype: IonxSelect;
  new (): IonxSelect;
};
 ...
 */
export declare const defineIonxSelect: (opts?: any) => void;
