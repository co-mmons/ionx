...
const IonxSelect = /*@__PURE__*/proxyCustomElement(Select, [6,"ionx-select",{"placeholder":[1],"overlay":[1],"overlayTitle":[1,"overlay-title"],"overlayOptions":[16],"alwaysArray":[4,"always-array"],"comparator":[1],"multiple":[4],"sortable":[4],"empty":[4],"readonly":[4],"disabled":[4],"searchTest":[16],"checkValidator":[16],"options":[16],"items":[16],"lazyItems":[16],"labelComponent":[1,"label-component"],"labelFormatter":[16],"separator":[1],"value":[1032],"prefetch":[4]},[[0,"focus","onFocus"],[0,"blur","onBlur"]]]);
