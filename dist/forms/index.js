...
let FormField = class extends HTMLElement {
  ...
  render() {
    return h$1(Host, { class: { "ionx--has-error": !!this.errorMessage } }, h$1("fieldset", null, h$1("legend", null, h$1("div", { "slot-container": "label" }, h$1("slot", { name: "label" }, this.label)), h$1("div", { "slot-container": "label-end" }, h$1("slot", { name: "label-end" })), this.collapsible && h$1("ion-button", { class: "ionx--expand-toggle", shape: "round", size: "small", fill: "clear", onClick: () => this.toggleExpanded() }, h$1("ion-icon", { name: "chevron-up", slot: "icon-only" }))), h$1("div", { "slot-container": "description" }, h$1("slot", { name: "description" })), h$1("div", { "slot-container": "placeholder" }, h$1("slot", { name: "placeholder" })), h$1("div", { "ionx--content": true, style: { display: this.flexContent ? "flex" : "block" } }, h$1("div", { "slot-container": "start" }, h$1("slot", { name: "start" })), h$1("div", { "slot-container": "default" }, h$1("slot", null)), h$1("div", { "slot-container": "end" }, h$1("slot", { name: "end" })))), h$1("div", { "slot-container": "error" }, this.errorMessage && h$1("span", { slot: "error" }, this.errorMessage), h$1("slot", { name: "error" })), h$1("div", { "slot-container": "hint" }, h$1("slot", { name: "hint" })));
  }
