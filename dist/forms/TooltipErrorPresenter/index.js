...
const TooltipErrorPresenter = "ionx-form-tooltip-error-presenter";
...
let TooltipErrorPresenterComponent = class extends HTMLElement {
  ...
  connectedCallback() {
    ...
    if (this.instance$) {
      const form = this.element.closest("ionx-form");
      if (form?.controller) {
...
export { IonxFormTooltipErrorPresenter, TooltipErrorPresenter, TooltipErrorPresenterImpl, defineIonxFormsTooltipErrorPresenter };
