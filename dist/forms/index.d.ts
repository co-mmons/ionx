...
export const IonxFormField: {
  prototype: IonxFormField;
  new (): IonxFormField;
};

interface IonxFormItem extends Components.IonxFormItem, HTMLElement {}
export const IonxFormItem: {
  prototype: IonxFormItem;
  new (): IonxFormItem;
};
 ...
 */
export declare const defineIonxForms: (opts?: any) => void;
