...
const alignmentMenuCss = ":host{overflow:initial !important}:host ion-list{margin:8px 0;padding:0}:host ion-list ion-item{--border-width:0 0 var(--ionx-border-width) 0;--inner-border-width:0;--inner-padding-start:0;--inner-padding-end:0;--padding-start:16px;--padding-end:16px;font-size:var(--app-font-size, var(--ionx-default-font-size))}:host ion-list>ion-item.item:last-child,:host ion-list>*:last-child>ion-item.item:last-child{--border-width:0}:host ion-list ion-list-header{padding:8px 16px;font-size:calc(var(--ionx-default-font-size) - 3px);font-weight:700;align-items:flex-start;min-height:auto}:host ion-list ion-item>[slot=start]{margin-right:16px;margin-left:0px}:host ion-list ion-item ion-radio{width:1.5em;height:1.5em}:host ion-list ion-item.item ion-label{white-space:normal}:host ion-list ion-item.item ion-label small{display:block;line-height:1}:host ion-list ion-item-divider.item{--background:transparent;--color:rgb(var(--ion-text-color-rgb), .5);--padding-start:16px;--padding-end:16px;--padding-top:20px;--inner-border-width:0;--border-width:0;font-size:calc(var(--ionx-default-font-size, 16px) * 0.75);font-weight:500;border-bottom:var(--ionx-border-width) solid var(--ion-border-color);text-transform:uppercase;letter-spacing:1px}:host ion-list ion-icon[slot=start],:host ion-list ion-icon[slot=end]{font-size:1.2em}:host ion-list ion-icon[slot=start]{margin-right:8px}:host ion-list ion-icon[slot=end]{margin-right:0}";
...
const insertMenuCss = ":host{overflow:initial !important}:host ion-list{margin:8px 0;padding:0}:host ion-list ion-item{--border-width:0 0 var(--ionx-border-width) 0;--inner-border-width:0;--inner-padding-start:0;--inner-padding-end:0;--padding-start:16px;--padding-end:16px;font-size:var(--app-font-size, var(--ionx-default-font-size))}:host ion-list>ion-item.item:last-child,:host ion-list>*:last-child>ion-item.item:last-child{--border-width:0}:host ion-list ion-list-header{padding:8px 16px;font-size:calc(var(--ionx-default-font-size) - 3px);font-weight:700;align-items:flex-start;min-height:auto}:host ion-list ion-item>[slot=start]{margin-right:16px;margin-left:0px}:host ion-list ion-item ion-radio{width:1.5em;height:1.5em}:host ion-list ion-item.item ion-label{white-space:normal}:host ion-list ion-item.item ion-label small{display:block;line-height:1}:host ion-list ion-item-divider.item{--background:transparent;--color:rgb(var(--ion-text-color-rgb), .5);--padding-start:16px;--padding-end:16px;--padding-top:20px;--inner-border-width:0;--border-width:0;font-size:calc(var(--ionx-default-font-size, 16px) * 0.75);font-weight:500;border-bottom:var(--ionx-border-width) solid var(--ion-border-color);text-transform:uppercase;letter-spacing:1px}:host ion-list ion-icon[slot=start],:host ion-list ion-icon[slot=end]{font-size:1.2em}:host ion-list ion-icon[slot=start]{margin-right:8px}:host ion-list ion-icon[slot=end]{margin-right:0}";
...
const linkMenuCss = ":host{overflow:initial !important}:host ion-list{margin:8px 0;padding:0}:host ion-list ion-item{--border-width:0 0 var(--ionx-border-width) 0;--inner-border-width:0;--inner-padding-start:0;--inner-padding-end:0;--padding-start:16px;--padding-end:16px;font-size:var(--app-font-size, var(--ionx-default-font-size))}:host ion-list>ion-item.item:last-child,:host ion-list>*:last-child>ion-item.item:last-child{--border-width:0}:host ion-list ion-list-header{padding:8px 16px;font-size:calc(var(--ionx-default-font-size) - 3px);font-weight:700;align-items:flex-start;min-height:auto}:host ion-list ion-item>[slot=start]{margin-right:16px;margin-left:0px}:host ion-list ion-item ion-radio{width:1.5em;height:1.5em}:host ion-list ion-item.item ion-label{white-space:normal}:host ion-list ion-item.item ion-label small{display:block;line-height:1}:host ion-list ion-item-divider.item{--background:transparent;--color:rgb(var(--ion-text-color-rgb), .5);--padding-start:16px;--padding-end:16px;--padding-top:20px;--inner-border-width:0;--border-width:0;font-size:calc(var(--ionx-default-font-size, 16px) * 0.75);font-weight:500;border-bottom:var(--ionx-border-width) solid var(--ion-border-color);text-transform:uppercase;letter-spacing:1px}:host ion-list ion-icon[slot=start],:host ion-list ion-icon[slot=end]{font-size:1.2em}:host ion-list ion-icon[slot=start]{margin-right:8px}:host ion-list ion-icon[slot=end]{margin-right:0}";
...
const listMenuCss = ":host{overflow:initial !important}:host ion-list{margin:8px 0;padding:0}:host ion-list ion-item{--border-width:0 0 var(--ionx-border-width) 0;--inner-border-width:0;--inner-padding-start:0;--inner-padding-end:0;--padding-start:16px;--padding-end:16px;font-size:var(--app-font-size, var(--ionx-default-font-size))}:host ion-list>ion-item.item:last-child,:host ion-list>*:last-child>ion-item.item:last-child{--border-width:0}:host ion-list ion-list-header{padding:8px 16px;font-size:calc(var(--ionx-default-font-size) - 3px);font-weight:700;align-items:flex-start;min-height:auto}:host ion-list ion-item>[slot=start]{margin-right:16px;margin-left:0px}:host ion-list ion-item ion-radio{width:1.5em;height:1.5em}:host ion-list ion-item.item ion-label{white-space:normal}:host ion-list ion-item.item ion-label small{display:block;line-height:1}:host ion-list ion-item-divider.item{--background:transparent;--color:rgb(var(--ion-text-color-rgb), .5);--padding-start:16px;--padding-end:16px;--padding-top:20px;--inner-border-width:0;--border-width:0;font-size:calc(var(--ionx-default-font-size, 16px) * 0.75);font-weight:500;border-bottom:var(--ionx-border-width) solid var(--ion-border-color);text-transform:uppercase;letter-spacing:1px}:host ion-list ion-icon[slot=start],:host ion-list ion-icon[slot=end]{font-size:1.2em}:host ion-list ion-icon[slot=start]{margin-right:8px}:host ion-list ion-icon[slot=end]{margin-right:0}";
...
const paragraphMenuCss = ":host{overflow:initial !important}:host ion-list{margin:8px 0;padding:0}:host ion-list ion-item{--border-width:0 0 var(--ionx-border-width) 0;--inner-border-width:0;--inner-padding-start:0;--inner-padding-end:0;--padding-start:16px;--padding-end:16px;font-size:var(--app-font-size, var(--ionx-default-font-size))}:host ion-list>ion-item.item:last-child,:host ion-list>*:last-child>ion-item.item:last-child{--border-width:0}:host ion-list ion-list-header{padding:8px 16px;font-size:calc(var(--ionx-default-font-size) - 3px);font-weight:700;align-items:flex-start;min-height:auto}:host ion-list ion-item>[slot=start]{margin-right:16px;margin-left:0px}:host ion-list ion-item ion-radio{width:1.5em;height:1.5em}:host ion-list ion-item.item ion-label{white-space:normal}:host ion-list ion-item.item ion-label small{display:block;line-height:1}:host ion-list ion-item-divider.item{--background:transparent;--color:rgb(var(--ion-text-color-rgb), .5);--padding-start:16px;--padding-end:16px;--padding-top:20px;--inner-border-width:0;--border-width:0;font-size:calc(var(--ionx-default-font-size, 16px) * 0.75);font-weight:500;border-bottom:var(--ionx-border-width) solid var(--ion-border-color);text-transform:uppercase;letter-spacing:1px}:host ion-list ion-icon[slot=start],:host ion-list ion-icon[slot=end]{font-size:1.2em}:host ion-list ion-icon[slot=start]{margin-right:8px}:host ion-list ion-icon[slot=end]{margin-right:0}";
...
const textMenuCss = ":host{overflow:initial !important}:host ion-list{margin:8px 0;padding:0}:host ion-list ion-item{--border-width:0 0 var(--ionx-border-width) 0;--inner-border-width:0;--inner-padding-start:0;--inner-padding-end:0;--padding-start:16px;--padding-end:16px;font-size:var(--app-font-size, var(--ionx-default-font-size))}:host ion-list>ion-item.item:last-child,:host ion-list>*:last-child>ion-item.item:last-child{--border-width:0}:host ion-list ion-list-header{padding:8px 16px;font-size:calc(var(--ionx-default-font-size) - 3px);font-weight:700;align-items:flex-start;min-height:auto}:host ion-list ion-item>[slot=start]{margin-right:16px;margin-left:0px}:host ion-list ion-item ion-radio{width:1.5em;height:1.5em}:host ion-list ion-item.item ion-label{white-space:normal}:host ion-list ion-item.item ion-label small{display:block;line-height:1}:host ion-list ion-item-divider.item{--background:transparent;--color:rgb(var(--ion-text-color-rgb), .5);--padding-start:16px;--padding-end:16px;--padding-top:20px;--inner-border-width:0;--border-width:0;font-size:calc(var(--ionx-default-font-size, 16px) * 0.75);font-weight:500;border-bottom:var(--ionx-border-width) solid var(--ion-border-color);text-transform:uppercase;letter-spacing:1px}:host ion-list ion-icon[slot=start],:host ion-list ion-icon[slot=end]{font-size:1.2em}:host ion-list ion-icon[slot=start]{margin-right:8px}:host ion-list ion-icon[slot=end]{margin-right:0}:host input[type=color]{width:24px;height:24px;border:1px solid var(--ion-border-color);background-color:transparent;margin:0 0 0 8px;outline:none}:host ion-button[slot=end],:host ion-icon[slot=end]{margin:0}";
