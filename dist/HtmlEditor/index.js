...
const index_es$2 = /*#__PURE__*/Object.freeze({
  __proto__: null,
...
const index_es$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
...
function joinBackward(state, dispatch, view) {
  ...
  var $cut = findCutBefore$1($cursor);
...
const prosemirrorState = /*@__PURE__*/getAugmentedNamespace(index_es$1);

const prosemirrorModel = /*@__PURE__*/getAugmentedNamespace(index_es$2);

const prosemirrorTables = /*@__PURE__*/getAugmentedNamespace(index_es);
...
const ListMenu = class extends HTMLElement {
  ...
  connectedCallback() {
    this.editor.getView().then(view => {
      this.activeUnnumberedList = !!dist.findParentNode(predicate => predicate.hasMarkup(schema.nodes.bulletList))(view.state.selection);
      this.activeNumberedList = !!dist.findParentNode(predicate => predicate.hasMarkup(schema.nodes.orderedList))(view.state.selection);
    });
  }
  render() {
    return h("ion-list", { lines: "full" }, h("ion-item", { button: true, detail: false, onClick: () => this.toggleList("bulletList") }, h("ion-label", null, intl.message `ionx/HtmlEditor#listMenu/Bulleted list`), h("ion-icon", { src: "/assets/ionx.HtmlEditor/icons/list-bulleted.svg", slot: "start" }), this.activeUnnumberedList && h("ion-icon", { name: "checkmark", slot: "end" })), h("ion-item", { button: true, detail: false, onClick: () => this.toggleList("orderedList") }, h("ion-label", null, intl.message `ionx/HtmlEditor#listMenu/Numbered list`), h("ion-icon", { src: "/assets/ionx.HtmlEditor/icons/list-numbered.svg", slot: "start" }), this.activeNumberedList && h("ion-icon", { name: "checkmark", slot: "end" })), (this.activeNumberedList || this.activeUnnumberedList) && h(Fragment$1, null, h("ion-item-divider", null, h("ion-label", null, intl.message `ionx/HtmlEditor#listMenu/Indent`)), h("ion-item", { button: true, detail: false, onClick: () => this.level(-1) }, h("ion-label", null, intl.message `ionx/HtmlEditor#listMenu/Decrease indent`), h("ion-icon", { src: "/assets/ionx.HtmlEditor/icons/indent-decrease.svg", slot: "start" })), h("ion-item", { button: true, detail: false, onClick: () => this.level(1) }, h("ion-label", null, intl.message `ionx/HtmlEditor#listMenu/Increase indent`), h("ion-icon", { src: "/assets/ionx.HtmlEditor/icons/indent-increase.svg", slot: "start" }))));
  }
