import {Component, ComponentInterface, Element, Event, EventEmitter, Host, Method, Prop, Watch, h, getMode} from '@stencil/core';
import {SwiperInterface, Swiper} from "./swiper";
...
export class Slides implements ComponentInterface {
  ...
  @Element() el!: HTMLIonxSlidesElement;
